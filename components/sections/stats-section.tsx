    ...
    >
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          ...
          <span className="text-xs font-semibold tracking-widest uppercase" style={{ color: "#DC2626" }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="rounded-2xl p-6 text-center border transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-1"
                style={{
                  backgroundColor: "#ffffff",
                  borderColor: "#DC262615",
                  boxShadow: "0 2px 16px #DC262608",
                }}
              >
                <div
                  className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  style={{
                    background: "radial-gradient(circle at center, #DC262608 0%, transparent 70%)",
                  }}
                />
                ...
                <div className="text-xs font-medium tracking-wide uppercase" style={{ color: "#6B7280" }}>
                  {stat.label}
                </div>
                <div
